...
def home():
    ...
    st.write(
        ...
        Instead, perhaps we can sample from a well-known distribution, and somehow construct a function that maps the well known distribution into the distribution we actually care about.
        This is what diffusion models do.
        
        While we're still talking at the high level, here, it's worth noting that 
        """
    )
    st.write(
